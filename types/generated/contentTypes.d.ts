...
export interface ApiCourseProgressCourseProgress
  ...
  attributes: {
    courseContentid: Schema.Attribute.Integer;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    topics: Schema.Attribute.Component<'details.details', true>;
    type: Schema.Attribute.Enumeration<['advance', 'basic']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiVV extends Struct.CollectionTypeSchema {
  collectionName: 'vs';
  info: {
    description: '';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::v.v'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    VideoTopic: Schema.Attribute.Component<'video-topics.video-topics', true>;
